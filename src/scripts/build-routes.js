...
function buildRoutes(routesPath = './src/app/routes') {
    console.log(`🔨 Scanning routes for webpack build...`);
    
    try {        console.log(`✅ Routes will be bundled into the virtual file system using routes-map.ts`);
        ...
        console.log(`📄 Routes will be dynamically imported at runtime`);
          // 소스 라우트 파일 목록 표시
        const sourcePath = path.join(process.cwd(), routesPath);
